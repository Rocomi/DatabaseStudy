...
SELECT SEQ_EMPNO.CURRVAL FROM DUAL; --   오류 발생 ! NEXTVAL 를 한번도 수행하지 않은 이상 CURRVAL는 사용할 수 없음!

SELECT SEQ_EMPNO.NEXTVAL FROM DUAL; --  생성후 처음 수행 시 시작값 300 으로 지정
